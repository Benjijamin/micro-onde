	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Color = ( float4( tex2DNode41.rgb , 0.0 ) * input.ase_color ).rgb;
				float Alpha = ( tex2DNode41.a * input.ase_color.a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = ( tex2DNode41.a * input.ase_color.a );
				#if defined( _ALPHATEST_ON )
...
ASEEND*/
//CHKSM=FBF305DB31B0CBB890F1500E4CEF865D30CA759B