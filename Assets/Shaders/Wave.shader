	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Color = ( input.ase_color * float4( tex2DNode1.rgb , 0.0 ) ).rgb;
				float Alpha = ( input.ase_color.a * tex2DNode1.a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = ( input.ase_color.a * tex2DNode1.a );
				#if defined( _ALPHATEST_ON )
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_TEX = input.ase_texcoord1.xy * _TEX_ST.xy + _TEX_ST.zw;
				float4 tex2DNode1 = tex2D( _TEX, uv_TEX );
